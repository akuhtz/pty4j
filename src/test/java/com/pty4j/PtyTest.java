...
public class PtyTest extends TestCase {
    ...
    /**
     * Tests that closing the Pty after the child process is finished works normally. Should keep track of issue #1.
     */
    ...
    /**
     * Tests that the child process is terminated if the {@link com.pty4j.unix.Pty} closed before the child process is
     * finished. Should keep track of issue #1.
     */
    ...
    /**
     * Tests that we can execute a process in a Pty, and wait for its normal termination.
     */
    ...
    public void testConsoleMode() throws Exception {
        ...
        if (Platform.isWindows()) {
            ...
            assumeTrue(file.exists());
            command = new String[] { "/bin/sh", file.getAbsolutePath() };
        }
